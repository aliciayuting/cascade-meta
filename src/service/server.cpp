...
int main(int argc, char** argv) {
    ...
    Service<VolatileCascadeMetadataWithStringKey,VolatileCascadeStoreWithStringKey,PersistentCascadeStoreWithStringKey>::start(group_layout,
            {&cdpo_vcms,&cdpo_vcss,&cdpo_pcss},
            vcms_factory,vcss_factory,pcss_factory);
